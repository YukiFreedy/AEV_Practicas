...
{
 {getUsername, "Username", "Shows the username of the current user"},
 {lcdMainOnBottom, "Turn upper screen the main one", "Turns the upper screen the main one"},
 {lcdMainOnTop, "Turn bottom screen the main one", "Turns the bottom screen the main one"},
 {lcdSwap, "Swap Screens", "Swaps the screens"},
 {ledBlinking, "Led Blink", "The led will blink"},
 {systemShutDown, "ShutDown", "Shuts down the system"},
 {systemSleep, "Sleep", "Sleeps the system"},
};
...
//---------------------------------------------------------------------------------
	...
	while(1) {
		...
		while(!selected) {
            ...
            iprintf("Made by: %s", "Victor Ribera Vazquez\n");
